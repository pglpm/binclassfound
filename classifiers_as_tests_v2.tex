...
%% Last-Updated: 2022-05-23T10:37:21+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{equation}
  ...
  \P(\texts{class of new unit} \|
  \texts{feature of new unit}, \texts{training data})
\end{equation}
...
Now we acknowledge the fact that the information contained in the feature, relevant to the class, is simply inaccessible to us because of computational reasons.
