...
%% Last-Updated: 2022-05-25T18:39:00+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{equation}
where $\No$ is a gaussian, \eqn~\eqref{eq:distr_output}, $L(y)$ is a logit transformation (together with a small contraction around $0.5$ to take care of $0$ and $1$ values) that maps the output $y\in \clcl{0,1}$ onto the real numbers \autocites[\cf][\sect~3.3 \eqn~(19)]{johnson1949}, and $L'(y)$ its Jacobian determinant. 
