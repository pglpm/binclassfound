...
%% Last-Updated: 2022-05-28T22:35:36+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The essential point of the decision-theoretic approach is that we first need to specify the utilities involved in the classification problem, collected in the utility matrix, because they determine
\begin{enumerate}[label=(\roman*)]
\item (together with the probabilities) which class we choose in each single instance;
\item the metric to evaluate the performance.
\end{enumerate}
...
\begin{equation}
  ...
  \umatrix{1}{0}{-10}{10} \ ,\quad
  \umatrix{1}{0}{-100}{100} \ ,\quad
  \umatrix{10}{-10}{0}{1} \ .
\end{equation}
