...
%% Last-Updated: 2022-05-24T11:46:13+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The generative mode, which is generally not available for classifiers with a discriminative design, is the required way to calculate the class probabilities if the calibration set does not have the same statistics as the population on which the classifier is employed; or in other words if it is not representative of that population.
