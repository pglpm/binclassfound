...
%% Last-Updated: 2022-05-24T12:20:30+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
The generative mode, which is generally not available for classifiers with a discriminative design, is the required way to calculate the class probabilities if the calibration set does not have the same statistics as the population on which the classifier is employed; or in other words if it is not representative of that population. This may occur quite often, for several reasons. 

\mynotep{situation may occur not because calibration set was badly chosen, but because we want to use classifier in a new situation, or if population has changed}

\mynotep{add use for combining evidence}
