...
%% Last-Updated: 2022-05-23T14:07:18+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{multline}
  ...
  \shoveleft{\sum_{\mathclap{\substack{\text{feature}\\\text{training data}}}}
  w(\texts{feature}, \texts{training data})
\times{}}\\[-1.5em]
  \P(\texts{class} \| \texts{feature},\,
  \texts{classes \amp\ features of training data}) \ .
\end{multline}
This means that the proxy probability is generally less sharp -- and therefore more conservative, that is farther away from $0$ and $1$ -- than the ideal one.
