...
%% Last-Updated: 2022-05-23T06:34:12+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
In the present work we propose an alternative solution to calculate proper class probabilities. It has a low computational cost, can be applied to all commonly used classifiers and even to simple regression algorithms, does not need any changes in algorithm architecture or in training procedures, and is grounded on first principles. It consists in a sort of \enquote{transducer} that transforms the algorithm raw output into a probability. We moreover combine the probability thus obtained with utilities to perform the final classification.
