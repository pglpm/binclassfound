...
%% Last-Updated: 2022-05-23T11:48:24+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Now we acknowledge the fact that the information contained in the feature and in the training data, relevant to the class of the new unit, is simply inaccessible to us because of computational reasons. We do have access to the output for the new unit, however, which does carry information. Thus what is available to us is the probability
\begin{equation}
  \label{eq:prob_only_output}
  \P(\texts{class of unit} \| \texts{output for unit}) \ .
\end{equation}
