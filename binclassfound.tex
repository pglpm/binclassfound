...
%% Last-Updated: 2022-04-12T19:19:19+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
The utility matrix is not only the basis for choosing optimal decisions by means of expected-utility maximization. It also provides a scale with which to rank a set of decisions already made, if we know the corresponding true classes. For example, if in instances $1,2,3,\dotsc, N$ we chose decisions $d_{1}, d_{2}, d_{3}, \dotsc d_{N}$ and  the true classes were $c_{1}, c_{2}, c_{3},\dotsc, c_{N}$, then the actual total utility gained is
\begin{equation}
  \label{eq:utility_gained}
  \sum_{i=1}^{N} \U(d_{i} \| c_{i}) \equiv
  \U(d_{1} \| c_{1}) +   \U(d_{2} \| c_{2}) +   \U(d_{3} \| c_{3}) + \dotsb
  + \U(d_{N} \| c_{N}) \ ,
\end{equation}
or an average utility per instance of
\begin{equation}
  \label{eq:avg_utility_gained}
\frac{1}{N}  \sum_{i=1}^{N} \U(d_{i} \| c_{i}) \ .
\end{equation}
