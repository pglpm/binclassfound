...
%% Last-Updated: 2022-04-02T12:22:23+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
utility of performing action $a$ if the individual has $X\mo x$ is
$U(a \| x)$; similarly for $b$. If we knew the value of $X$, say $X\mo 0$,
we would simply choose the action leading to maximal utility:
\begin{equation}
  \label{eq:choice_ex}
  \begin{aligned}
...
\\&\text{else}\quad\text{it is irrelevant which action is chosen}.
  \end{aligned}
\end{equation}
...
uncertain, the final utility of each action is also uncertain; we can
...
expected utility. So our choice is
\begin{equation}
  \label{eq:choice_uncertain}
  \begin{aligned}
    &\text{if}\quad \bar{U}(a \| Z \mo z) > \bar{U}(b \| Z \mo z) \quad\text{then choose action $a$},
\\
      &\text{if}\quad \bar{U}(a \| Z \mo z) < \bar{U}(b \| Z \mo z) \quad\text{then choose action $b$},
\\&\text{else}\quad\text{it is irrelevant which action is chosen}.
  \end{aligned}
\end{equation}
