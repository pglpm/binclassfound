...
%% Last-Updated: 2022-03-22T16:05:19+0100
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
possible evaluation metrics: accuracy, area under curve,
F\textsubscript{1}-measure, precision, recall, sensitivity, specificity,
and many others \citep{sammutetal2011_r2017}. Only vague guidelines are
usually given to face this choice.

Regarding such metrics, we can also ask: are they all well-founded and
self-consistent? is it possible that the use of any of them lead to
contradictions? Several studies show that using area under curve, for
example, may imply hidden contradictions with the data or the assumptions
used for our inference
\citep{swets1988,bakeretal2001,loboetal2008}.

If we have many more data for one of the two classes -- a common predicament in medical applications -- we must face the \enquote{class-imbalance problem}
