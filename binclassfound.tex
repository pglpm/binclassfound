...
%% Last-Updated: 2022-04-11T10:39:39+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
All these issues are plainly connected: they involve considerations of importance or gain or cost, and of uncertainty. In the present work we show that issues~\ref{item:scales}--\ref{item:optimal_true} can all be solved at once
