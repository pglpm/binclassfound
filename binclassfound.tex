...
%% Last-Updated: 2022-04-08T12:22:13+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
\item Assign probabilities to the two possible values of the unit's class, given the unit's feature $Z$, our sample data $D$, and any other available information:
  \begin{equation}
    \p(X\mo 0 \| Z, D), \qquad \p(X\mo 1 \| Z,D) \equiv 1- \p(X\mo 0 \| Z,D) \ ,
  \end{equation}
  ...
  \begin{equation}
    \begin{aligned}
      \eu(\za) &\defd U(\za \| X\mo 0) \ 
                 \p(X\mo 0 \| Z, D) + U(\za \| X\mo 1) \ 
                 \p(X\mo 1 \| Z, D)
      \\
      \eu(\zb) &\defd U(\zb \| X\mo 0) \ 
                 \p(X\mo 0 \| Z, D) + U(\zb \| X\mo 1) \ 
                 \p(X\mo 1 \| Z, D)
    \end{aligned}
\end{equation}
...
How does the probability calculus determine the probability $\p(X \| Z, D)$?




\mynote{old text below}
