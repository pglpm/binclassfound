...
%% Last-Updated: 2022-04-11T18:57:34+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
For example, we are offered to buy a lottery ticket, which may be winning or not. The ticket costs $1$ unit of some monetary currency to buy, and the lottery prize is $101$ units. Our available decisions are whether to buy the ticket or not. We have four utilities, displayed in this self-explanatory table:
\begin{center}
  \begin{tabular}{rcc}
    &\texttt{\small winner}&
    \texttt{\small loser}
    ...
    \\[0.5\jot]
    \texttt{\small buy}&$+100$&$-1$\\
    \texttt{\small don't buy}&$0$&$0$
  \end{tabular}
\end{center}

We denote $\U(d\|c)$ the utility of decision $d$ if class $c$ is true, or  \enquote{the utility of $d$ given $c$}, or \enquote{the utility of $d$ conditional on $c$}. For instance $\U(\texttt{\small buy} \| \texttt{\small loser}) = -1$.
