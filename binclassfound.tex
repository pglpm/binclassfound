...
%% Last-Updated: 2022-04-12T21:57:34+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
The expression above is a linear combination of the counts appearing in the confusion matrix $N_{\dotso}$. The coefficients of the linear combination are the elements of the utility matrix $U_{\dotso}$.

We thus find the following important result according to decision theory: \emph{a valuation score should be a \textbf{linear combination} of elements of the confusion matrix. The coefficients of the linear combination are \textbf{problem-specific} and represent the \textbf{utilities} associated with a true-positive classification, a false-positive classification, and so on.}
