...
%% Last-Updated: 2022-04-13T08:47:27+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newif\ifarxiv
\arxivfalse
...
According to decision theory, binary classification requires the specification of a 2-by-2 utility matrix, or 4 parameters. This utility matrix should also be used in evaluating the decisions made by the classification algorithm in a test set with $N$ datapoints. The decisions and corresponding true classes are embodied in the confusion matrix $(N_{dc})$, containing the number $N_{dc}$ of times we made decision $d$ when the true class was $c$. This is exactly the scenario presented at the end of the previous section. The average utility obtained by the classifier algorithm on the test set is thus given by
\begin{equation}
