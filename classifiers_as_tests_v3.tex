...
%% Last-Updated: 2022-05-30T12:55:20+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{table}[!ht]
  ...
  \begin{tabular*}{\linewidth}{lw{c}{0.12\linewidth}w{c}{0.12\linewidth}w{c}{0.12\linewidth}w{c}{0.12\linewidth}}
    ...
    &\textcolor{myred}{9.56}
      &\textcolor{myred}{9.08}
  \end{tabular*}
  \caption{Expected utilities for the two algorithms of \sect}
  \label{tab:algorithms_utilities}
\end{table}

The augmented \RF\ is optimal for cases~I--III, and there is no preference in case~IV. We emphasize again that \emph{this algorithm evaluation is done from the calibration set; no demonstration data are used}. Our results from the demonstration dataset, reported in table~\ref{tab:results_utilities}, corroborate these findings.
