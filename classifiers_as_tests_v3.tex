...
%% Last-Updated: 2022-05-30T13:13:40+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\section{Summary, discussion, and teasers of further developments}
...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.49\linewidth]{histogram_alg_utilities_1.pdf}\hfill
  \includegraphics[width=0.49\linewidth]{histogram_alg_utilities_2.pdf}\\
  \includegraphics[width=0.49\linewidth]{histogram_alg_utilities_3.pdf}\hfill
  \includegraphics[width=0.49\linewidth]{histogram_alg_utilities_4.pdf}\\
  \caption{\mynotew{}}
...
The augmented \RF\ is optimal for cases~I--III, and there is no preference in case~IV. We emphasize again that \emph{this algorithm evaluation is done from the calibration set; no demonstration data are used}. The results from the demonstration dataset, reported in table~\ref{tab:results_utilities}, corroborate these assessments.
