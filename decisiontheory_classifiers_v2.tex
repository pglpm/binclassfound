...
%% Last-Updated: 2022-05-16T14:18:59+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[p]
  \centering
    \includegraphics[width=\linewidth]{utility_vs_metrics_1001.jpg}\\
  \caption{Relationship between various metrics and utility}
  \label{fig:metrics_vs_utility}
\end{figure}
\begin{figure}[p]
  \centering
    \includegraphics[width=\linewidth]{utility_vs_metrics_15-35-335165.jpg}\\
  \caption{Relationship between various metrics and utility}
  \label{fig:metrics_vs_utility}
\end{figure}
