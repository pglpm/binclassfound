...
%% Last-Updated: 2022-05-14T18:32:39+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{equation}
  ...
  \sum_{ij} a\ U_{ij}\ C_{ij} + b
\end{equation}
because $\sum_{ij} C_{ij} \equiv 1$.

In the present context $N$, $f_{0}$, $f_{1}$ can be considered constants. We are therefore free to construct $a > 0$ and $b$ from $N$, $f_{0}$, $f_{1}$ in any way we please.
