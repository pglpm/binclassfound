...
%% Last-Updated: 2022-05-16T14:48:30+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% {B}\hfill\mbox{}\\[0pt]
{\color{mygrey}\rule{0.33\linewidth}{0.25pt}}
  \includegraphics[width=0.99\linewidth]{utility_vs_metrics_15-35-335165.jpg}\\
  \caption{Relationship between various metrics and utility for two different utility matrices. Upper panel: for the utility matrix $ \begin{bsmallmatrix} 1&0\\0&1 \end{bsmallmatrix} $. Lower panel: for the utility matrix $ \begin{bsmallmatrix} 15 & -335  \\ -35 & 165 \end{bsmallmatrix} $, \eqn~\eqref{eq:utility_example}. The pairs of red triangles represent confusion matrices that are incorrectly ranked by the metric reported on the $y$-axis. \mynotep{blah}}
