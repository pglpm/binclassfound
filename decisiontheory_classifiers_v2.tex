...
%% Last-Updated: 2022-05-18T08:36:16+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{figure}[p]
  \centering
  %{A}\hfill\mbox{}\\[0pt]
\includegraphics[width=0.99\linewidth]{utility_vs_metrics_0.5.jpg}\\[0pt]
% {B}\hfill\mbox{}\\[0pt]
% \vspace{-1em}{\color{mygrey}\rule{0.66\linewidth}{0.25pt}}
% \includegraphics[width=0.95\linewidth]{utility_vs_metrics_0.8.jpg}\\[0pt]
\caption{\mynotew{to be rewritten} Relationship between various metrics and actual utility yield for a binary-classification problem with underlying utility matrix $ \begin{bsmallmatrix} 1&0\\0&1 \end{bsmallmatrix} $. Upper panel: balanced dataset, either class with $50\%$ frequency. Lower panel: imbalanced dataset, class~$0$  with $80\%$ frequency.
...
\begin{figure}[p]
  \centering
  %{A}\hfill\mbox{}\\[0pt]
\includegraphics[width=0.99\linewidth]{utility_vs_metrics_0.8.jpg}\\[0pt]
% {B}\hfill\mbox{}\\[0pt]
% \vspace{-1em}{\color{mygrey}\rule{0.66\linewidth}{0.25pt}}
