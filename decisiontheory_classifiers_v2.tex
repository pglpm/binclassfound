...
%% Last-Updated: 2022-05-14T19:44:01+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{empheq}
In this formula $(C_{ij})$ is either the raw confusion matrix or the fully-normalized one (grand sum of all entries is unity), since the two differ by a factor $N$ which can be incorporated in the constant $a$. However, \emph{the formula is not valid for row-wise or column-wise normalized confusion matrices}. These kinds of normalizations should not be used \mynotew{Add remark about this in the final summary}
