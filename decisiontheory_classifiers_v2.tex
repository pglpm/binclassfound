...
%% Last-Updated: 2022-05-16T22:24:17+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
In all these plots we see that it is  always possible to find two or more confusion matrices (pairs of yellow non-triangular shapes) for which the $F_{1}$-measure or the Matthews Correlation Coefficient give completely reversed rankings, scoring the worst confusion matrix (and the algorithm yielding it) as the best, and the best as the worst. It is even possible to find at least two confusion matrices (pairs of red triangular shapes) for which both these metrics simultaneously give the wrong ranking. It turns out that \emph{there is no classification problem for which these wrong-classification cases do not occur}. This is the second phenomenon mentioned above.
