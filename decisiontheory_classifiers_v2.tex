...
%% Last-Updated: 2022-05-07T14:47:30+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\end{align*}
That is, classifier B actually led to a \emph{loss} of revenue. The manager therefore decides to employ classifier A, commenting with a smug smile that the developers' recommendation was very poor.
...
Taking the sum of the products of the gains above by the respective percentages of occurrence -- which are the elements of a confusion matrix -- gives the final average gain. In the present case, the confusion matrices~\eqref{eq:CM_A} and \eqref{eq:CM_B} lead to the amounts found by the manager.
