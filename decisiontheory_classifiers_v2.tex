...
%% Last-Updated: 2022-05-19T21:18:39+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
\item Two possible distribution of true utility matrices on the set of \fig~\ref{fig:space_UM} (in that coordinate system): a uniform distribution, and a bivariate gaussian distribution centred on the identity matrix $\begin{bsmallmatrix} 1&0\\0&0 \end{bsmallmatrix}$ and with $0.5$ standard deviation in the $x$ and $y$ coordinates of \eqn~\eqref{eq:coords_um}.
...
\item A gaussian distribution of error around each true utility-matrix element, centred on the true utility value. We consider standard deviations ranging from $0.01$  to $0.5$. Note that each true utility has a value between $0$ and $1$.
\end{itemize}
