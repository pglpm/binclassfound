...
%% Last-Updated: 2022-05-19T11:50:13+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
A precise answer to these questions is extremely difficult if not impossible because to define \enquote{on average} we would need to conduct a survey of classification problems of any kind, collecting statistics about their underlying utility matrices and about the confusion matrices of candidate classification algorithms for their solution. We try to give a cursory answer to these questions for the binary-classification case, based on the following assumptions and judgements:
\begin{itemize}
\item A uniform distribution of utility matrices on the set of \fig~\ref{fig:space_UM} (in that coordinate system).
\item A distribution of confusion matrices for which the fraction of one class is uniformly distributed in $\clcl{0,1}$, and the true-positive and true-negative rates are independently distributed in $\clcl{0.5, 1}$ with linearly increasing probabilities. This means that we consider problems with highly imbalanced data to be as common as problems with balanced data (a realistic assumption according to our expecience); and that candidate classifiers tend to be good (median of 85\% true-positive and true-negative rates, lower and upper quartiles at 75\% and 93\%).
\end{itemize}
