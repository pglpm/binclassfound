...
%% Last-Updated: 2022-05-19T16:56:09+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\item\label{item:draw_wrongum} draw some errors committed around the elements of the true utility matrix, and add them to it;
\item draw a class proportion; 
\item draw two confusion matrices having that class proportion (the class proportion must be the same since the matrices are obtained from the same data);
\item calculate the difference in the true utility yield of the two confusion matrices, using the true utility from~\ref{item:draw_um};
\item calculate the difference in
  \begin{enumerate}
  \item the scores of the two confusion matrices according to several metrics;
  \item the  yields according to the erroneous utility matrix from~\ref{item:draw_wrongum}
  \end{enumerate}
\end{enumerate}
