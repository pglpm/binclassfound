...
%% Last-Updated: 2022-05-19T14:51:31+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
Under these assumptions we calculate how often a pair of classifiers, represented by two confusion matrices with the same class proportions, is evaluated in reverse order, with respect to their true utility yield, when an incorrect utility matrix is used and also when some other popular metrics are used.

This is an integration problem that we solve by Monte Carlo sampling; the procedure is intuitive:
\begin{enumerate}[label=\arabic*.]
\item draw a \enquote{true} utility matrix;
\item draw a class proportion; 
\item draw two confusion matrices having that class proportion; 
\end{enumerate}

We then consider all possible pairwise comparative evaluations as follows:
...
\begin{figure}[p]
  \centering
    \includegraphics[width=0.99\linewidth]{incorrectscores2_25.jpg}\\
