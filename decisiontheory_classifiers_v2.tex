...
%% Last-Updated: 2022-05-16T15:03:55+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
First, as discussed in \sect~\ref{sec:decision_theory} the metric involves an interdependence of utilities and classification frequencies, which implies some form of cognitive bias.
...
No matter which utility matrix we choose, the incompliant metric will rank some pairs of confusion matrices in the
