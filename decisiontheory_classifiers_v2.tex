...
%% Last-Updated: 2022-05-24T08:47:09+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{equation*}
  0.27\cdot 15\,\text{\texteuro} +
  0.15\cdot (-335)\,\text{\texteuro}+
  0.23\cdot (-35)\,\text{\texteuro} +
  0.35\cdot 165\,\text{\texteuro} =
  3.5 \,\text{\texteuro} \ .
\end{equation*}
...
Second, it leads to a mathematically simple, computationally convenient metric: a linear combination of confusion-matrix elements. No need of non-linear functions or of the integration of curves.
