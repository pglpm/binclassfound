...
%% Last-Updated: 2022-05-06T14:02:26+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
A factory which produces some kind of widgets wishes to employ a machine-learning classifier to assess whether each produced widget is good or faulty. The classifier takes some features of a widget as input and outputs one of the two labels \enquote{positive} for putatively good widget, or \enquote{negative} for a putatively faulty one.
...
\begin{equation*}
  \rotatebox[origin=c]{90}{
    \textit{\parbox{\widthof{classifier}}{\centering\scriptsize classifier\\output\\$-\quad+$}}
    }\ 
    \overbracket[0pt]{
      \begin{bmatrix}
    \text{\footnotesize True Positive} & \text{\footnotesize False Positive}\\
    \text{\footnotesize False Negative} & \text{\footnotesize True Negative}\\
      \end{bmatrix}}^{
      \textit{\parbox{\widthof{true widget condition}}{\centering\scriptsize true widget condition\\$+\hspace{\stretch{1}}-$}}
    }
\end{equation*}
...
\ .
\end{align}
These matrices show that the factory produces on average 50\% good and 50\% faulty gadgets.
