...
%% Last-Updated: 2022-05-15T12:27:11+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{itemize}
\item[\itemyes] \emph{Accuracy:} $C_{00}+C_{11}$. It is a particular case of formula~\eqref{eq:general_valuation_metric} with $a=1$, $\cx=\cy=1$, $b=0$. Indeed it corresponds to the evaluation metric based on the utility matrix $(U_{ij}) = \begin{bsmallmatrix} 1&0\\0&1 \end{bsmallmatrix}$.
  
\item[\itemyes] \emph{True-positive rate (recall):} $C_{00}/f_{0}$. It is  formula~\eqref{eq:general_valuation_metric} with $a=1/f_{0}$, $\cx=1$, $\cy=0$, $b=0$. It corresponds to using the utility matrix $\begin{bsmallmatrix} 1&0\\0&0 \end{bsmallmatrix}$. 

\item[\itemyes] \emph{True-negative rate (specificity):} $C_{11}/f_{1}$. We have $a=1/f_{1}$, $\cx=0$, $\cy=1$, $b=0$. It corresponds to using the utility matrix $\begin{bsmallmatrix} 0&0\\0&1 \end{bsmallmatrix}$. 
