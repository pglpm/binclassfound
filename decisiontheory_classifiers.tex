...
%% Last-Updated: 2022-04-14T18:13:30+0200
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\newcommand*{\propertitle}{Guessing what's true or choosing what's optimal?\\ {\Large A first-principle approach to the use and evaluation of classifiers}}
...
We must first address issue~\ref{item:no_probs}, the assessment of sensible probabilities for the possible classes, to be able to address the issues of optimality vs truth~\ref{item:optimal_true} and class imbalance~\ref{item:class_imbal}.
